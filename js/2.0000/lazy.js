    ...
    if ("app" in global) {
        ...
        lazy.addProperties({
            ...
            init: function (placeholder, options) {
                ...
                if (
                    lazy.elementExists(args.placeholder.querySelector(args.tag))
                ) {
                    args.placeholder.classList.add("load-item--success");
                    args.placeholder
                        .querySelector(args.tag)
                        .classList.add("load-item__success");

                    return false;
                }

                if (placeholder.classList.contains("load-item--progress")) {
                    return false;
                }
